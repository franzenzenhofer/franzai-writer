...
Call log:
  - waiting for locator('h3:has-text("Styled HTML")') to be visible

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/poem-workflow-comprehensive.spec.ts:54:16
```
...
- banner:
  ...
  - navigation
- main:
  - heading "Crimson Mirror of the Peaks" [level=1]
  ...
  - button:
    - img
  - text: Poem Title Crimson Mirror of the Peaks Poem Content A canvas stretched, where silence holds its sway, The glassy lake, anticipates the dying day. No ripple stirs, no whisper breaks the calm, Just nature's breath, a soothing, gentle balm. Then hues ignite, as sun descends in grace, Orange, gold, and rose light up the watery space. The surface gleams, a liquid fire-glow, Reflecting clouds in a slow, ethereal show. Behind this dream, the ancient mountains stand, Majestic guards across the fading land. Their shadowed peaks, in purple, soft and deep, A timeless watch, while twilight starts to creep. A perfect peace, descends on all below, Where sky meets earth, in an iridescent glow. This hallowed hour, a moment to behold, A story whispered, silently unfolds.
  - button:
    - img
  ...
  - button:
    - img
  - text: Optimized Imagen Prompt Artistic rendering of a tranquil mountain lake at sunset. The glassy surface perfectly mirrors the sky, ablaze with a liquid fire-glow of vibrant orange, shimmering gold, and soft rose hues. Wisps of ethereal clouds are flawlessly reflected, creating an iridescent spectacle. In the background, majestic, ancient mountain peaks stand silhouetted, their shadowed forms cast in deep, soft purple tones against the fading twilight. The scene evokes a profound sense of perfect peace and hallowed beauty, with a seamless blend of sky and earth. Generated Filenames Twilight Mountain Serenity Hallowed Lake Reflection
  - textbox "Optional notes for AI regeneration..."
  - button "AI REDO":
    - img
    - text: AI REDO
  ...
  - button:
    - img
  - 'img "Generated image: Artistic rendering of a tranquil mountain lake at sunset. The glassy surface perfectly mirrors the sky, ablaze with a liquid fire-glow of vibrant orange, shimmering gold, and soft rose hues. Wisps of ethereal clouds are flawlessly reflected, creating an iridescent spectacle. In the background, majestic, ancient mountain peaks stand silhouetted, their shadowed forms cast in deep, soft purple tones against the fading twilight. The scene evokes a profound sense of perfect peace and hallowed beauty, with a seamless blend of sky and earth."'
  - text: 3:4
  - button "Download":
    - img
    - text: Download
