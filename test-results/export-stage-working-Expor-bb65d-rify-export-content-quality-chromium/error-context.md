...
- banner:
  ...
  - navigation:
    - link "Login":
      - /url: /login
- main:
  - heading "Crags of Prose, Peaks of Precision" [level=1]
  - paragraph: "Workflow: Poem Generator"
  - text: Progress 2 / 8 Stages
  - progressbar
  - text: Last saved 9:34:36 PM
  - img
  ...
  - button:
    - img
  - text: Poem Title Crags of Prose, Peaks of Precision Poem Content A granite giant, etched in azure skies, A silent sentinel, where eagles rise. Each jagged edge, a phrase of strength untold, A story whispered, centuries old. We test the echo, clarity we seek, To match the mountain's grandeur, strong and sleek. No flawed description can this vista claim, Perfection's summit, is our testing game. The snow-capped peaks, like commas in the verse, Punctuate the rhythm, make the meaning terse. Each glacial valley, a paragraph profound, Where ancient wisdom can forever be found. We probe the language, searching for the flaw, A misplaced adjective, a grammatical law. For authenticity, we strive with might, To paint the picture, flawlessly bright. From verdant foothills to the icy crown, A symphony of nature, up and down. We analyze the flow, the narrative's grace, Ensuring every detail finds its rightful place. A metaphor misplaced, a simile askew, Distorts the image, makes the vision untrue. So meticulously, we dissect and weigh, The words we choose, to capture beauty's sway. Let every reader, standing at the base, Feel the mountain's presence, time cannot erase. Through crafted phrases, sharp and clear and bold, A tale of summits, accurately told. For in this testing, lies a deeper art, To share the mountain, hold it in the heart. A perfect export, mirroring its might, Bathed in truth's unwavering light.
  - button:
    - img
