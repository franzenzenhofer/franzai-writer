...
Call log:
  ...
  - waiting for locator('[data-testid="stage-card-generate-html-preview"]')
    6 × locator resolved to <div id="stage-generate-html-preview" data-testid="stage-card-generate-html-preview" class="rounded-lg border bg-card text-card-foreground mb-6 transition-all duration-300 border-primary shadow-accent/30 shadow-xl ring-2 ring-accent">…</div>
...
- banner:
  ...
  - navigation:
    - link "Login":
      - /url: /login
- main:
  - heading "Starlight Blossoms of Frostfell" [level=1]
  ...
  - button:
    - img
  - text: Poem Title Starlight Blossoms of Frostfell Poem Content Beneath a velvet sky, where starlight spills, A garden sleeps, yet with enchantment thrills. No earthly bloom, but crystalline and bright, Ice petals unfurl in the winter night. Each fragile stem, a prism catching gleam, A silent symphony, a frozen dream. From frosted earth, these wonders softly rise, A tapestry of ice beneath the skies. No mortal hand could craft such delicate grace, As starlight kisses every frozen space. Each shimmering leaf, a story to unfold, Of whispered secrets, centuries old. With breath held tight, I wander through the snow, A silent witness to this ethereal show. No sound but whispers of the winter breeze, Among the starlight-blooming, icy trees. A frosted moonbeams paint the landscape white, And banish shadows from the longest night. So let the world believe that winter's bare, For in this garden, beauty knows no care. These crystal blossoms, under starlight born, A timeless magic on this winter morn. And I, the keeper of this frozen art, Forever bound within its silent heart.
  - button:
    - img
  ...
  - button:
    - img
  - text: Optimized Imagen Prompt Artistic rendering of a frozen garden at night under a velvet, starlit sky. Crystalline ice petals unfurl, catching the starlight and creating a prism-like effect. Delicate ice stems rise from the frosted earth, forming a tapestry of ice. Shimmering ice leaves tell ancient stories. A frosted moonbeam illuminates the landscape, casting a soft, ethereal glow. The scene is silent and magical, capturing the essence of winter's beauty and enchantment. Artistic style. Generated Filenames frostfell-starlight-garden crystalline-winter-dream
  - textbox "Optional notes for AI regeneration..."
  - button "AI REDO":
    - img
    - text: AI REDO
  ...
  - button:
    - img
  - 'img "Generated image: Artistic rendering of a frozen garden at night under a velvet, starlit sky. Crystalline ice petals unfurl, catching the starlight and creating a prism-like effect. Delicate ice stems rise from the frosted earth, forming a tapestry of ice. Shimmering ice leaves tell ancient stories. A frosted moonbeam illuminates the landscape, casting a soft, ethereal glow. The scene is silent and magical, capturing the essence of winter''s beauty and enchantment. Artistic style."'
  - text: 3:4
  - button "Download":
    - img
    - text: Download
