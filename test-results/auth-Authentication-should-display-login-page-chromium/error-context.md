...
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:4:7
...
Locator: getByTestId('login-form-title')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('login-form-title')

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:7:56
```
