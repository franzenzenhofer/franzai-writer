...
- banner:
  ...
  - navigation:
    - link "Login":
      - /url: /login
- main:
  - heading "Twilight's Ember Dance" [level=1]
  - paragraph: "Workflow: Poem Generator"
  - text: Progress 2 / 8 Stages
  - progressbar
  - text: Last saved 9:34:28 PM
  - img
  ...
  - button:
    - img
  - text: Poem Title Twilight's Ember Dance Poem Content The lake lies still, a mirror deep, Reflecting skies where colors weep. A fiery kiss, the sun descends, As day surrenders, evening lends A velvet hush, a tranquil grace, Upon this solitary, peaceful place. Now shadows lengthen, soft and slow, Where whispering reeds begin to grow. And silver paints the water's skin, A canvas where the stars begin To prick the darkness, one by one, A celestial tapestry spun. A silent symphony unfolds, As nature's secrets are untold. From hidden havens, dark and cool, A thousand tiny sparks take rule. Fireflies awaken, small and bright, A living constellation in the night. They weave and flutter, twist and gleam, An ethereal, enchanting dream. Their ember dance, a silent call, A fleeting magic, holds us all. Lost in the beauty, we can see, The tranquil lake's serenity. Until the dawn, a gentle sigh, Beneath the starlit, watchful sky.
  - button:
    - img
