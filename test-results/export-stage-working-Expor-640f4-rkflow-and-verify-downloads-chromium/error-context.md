...
- banner:
  ...
  - navigation:
    - link "Login":
      - /url: /login
- main:
  - 'heading "Ember Embrace: Twilight Lake" [level=1]'
  ...
  - button:
    - img
  - text: "Poem Title Ember Embrace: Twilight Lake Poem Content The lake, a mirror, holds the fading light, Where crimson, gold, and amber softly blend, A canvas painted by the day's last might, As weary sun begins its slow descent. The air hangs heavy, sweet with summer's breath, A gentle stillness whispers through the trees, Reflecting skies in watery, tranquil death, Before the stars ignite with silent ease. Then, tiny sparks, like fallen pieces bright, Awaken in the reeds, a living gleam, Fireflies dance, embracing coming night, A silent ballet in a waking dream. They weave and flicker, painting paths unseen, Across the darkening, mirrored expanse, Ember embrace, a tranquil, hopeful scene, Lost in the twilight's captivating trance."
  - button:
    - img
