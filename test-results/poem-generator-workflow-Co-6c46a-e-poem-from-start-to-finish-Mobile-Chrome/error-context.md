...
- main:
  ...
  - button "Edit":
    ...
    - text: Edit
  - img
  - text: Generate Poem & Title AI will generate a poem and title based on your topic. Poem Title Golden Hour's Embrace Poem Content The sun, a painter with a golden brush, Across the canvas of the sky does rush. A gentle warmth upon my upturned face, A symphony of light in time and space. The emerald leaves in silent chorus sway, As breezes whisper secrets through the day. A robin's song, a cheerful, bright refrain, A joyful echo on the sunlit plain. The world awakens, bathed in radiant hue, A million diamonds shimmer in the dew. Each tiny blossom opens, bold and free, A vibrant promise for the world to see. Soak in the moment, let your worries cease, And find within this day a tranquil peace. Let golden hour's embrace both mend and heal, And find the beauty that the senses feel.
  - button:
    - img
