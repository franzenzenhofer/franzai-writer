...
Call log:
  ...
  - waiting for locator('[data-testid="stage-card-export-publish"]')
    7 × locator resolved to <div id="stage-export-publish" data-testid="stage-card-export-publish" class="rounded-lg border text-card-foreground shadow-sm mb-6 transition-all duration-300 min-h-[400px] border-primary bg-gradient-to-br from-background to-muted/20">…</div>
...
- banner:
  ...
  - navigation
- main:
  - 'heading "Starlight Bloom: A Crystalline Garden" [level=1]'
  - paragraph: "Workflow: Poem Generator"
  - text: Progress 7 / 8 Stages
  - progressbar
  - text: Last saved 7:30:21 AM
  - img
  ...
  - button:
    - img
  - text: "Poem Title Starlight Bloom: A Crystalline Garden Poem Content Where winter's breath is diamond dust, A garden sleeps, in starlight kissed. No verdant leaves, no summer's hue, But crystalline blooms, a shimmering view. Each petal carved from frozen light, A fragile dance in darkest night. Ice lilies gleam, with edges keen, And frosted roses, silver sheen. A quiet magic, held in thrall, Where moonbeams on the crystals fall. The air is still, a silent song, As starlight paints where shadows throng. No mortal hand could craft this scene, A winter's dream, serene and clean. Until the dawn, a whispered grace, In this crystalline, starlit place."
  - button:
    - img
  ...
  - button:
    - img
  - text: Optimized Imagen Prompt Artistic rendering of a frozen garden under a starlit sky. Crystalline flowers, including ice lilies and frosted roses with silver sheen, are illuminated by moonbeams. Diamond dust covers the scene, creating a shimmering, magical atmosphere. Fragile, frozen petals reflect the starlight in a silent, serene landscape. Darkest night. Winter's dream. Generated Filenames diamond-dust-garden frozen-light-dance
  - textbox "Optional notes for AI regeneration..."
  - button "AI REDO":
    - img
    - text: AI REDO
  ...
  - button:
    - img
  - 'img "Generated image: Artistic rendering of a frozen garden under a starlit sky. Crystalline flowers, including ice lilies and frosted roses with silver sheen, are illuminated by moonbeams. Diamond dust covers the scene, creating a shimmering, magical atmosphere. Fragile, frozen petals reflect the starlight in a silent, serene landscape. Darkest night. Winter''s dream."'
  - text: 3:4
  - button "Download":
    - img
    - text: Download
