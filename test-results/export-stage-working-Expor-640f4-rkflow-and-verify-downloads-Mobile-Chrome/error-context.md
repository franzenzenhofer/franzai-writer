...
- banner:
  ...
  - navigation
- main:
  - heading "Twilight's Firefly Ballet" [level=1]
  ...
  - button:
    - img
  - text: Poem Title Twilight's Firefly Ballet Poem Content The lake, a mirror, stills the fading light, Reflecting hues of amber, rose, and grey, A canvas painted by the day's last might, As shadows lengthen, chasing light away. Then silence falls, a breath held in the air, Before the whispers of the night begin, And stars ignite, like diamonds scattered there, While water sighs, escaping earthly din. From hidden reeds, a tiny spark takes flight, A firefly awakening from its sleep, A dancing ember in the velvet night, With secrets that the silent waters keep. They weave and glimmer, painting mystic trails, Across the surface, mirrored in the deep, A silent ballet where enchantment veils, The tranquil lake, as weary mortals sleep.
  - button:
    - img
