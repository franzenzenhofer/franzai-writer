...
Expected: > 0
Received:   0
    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/poem-workflow-working.spec.ts:84:28
```
  ...
  - table:
    ...
    - rowgroup:
      - row "New Poem Generator":
        ...
        - cell:
          - link:
            - /url: /w/poem/h8u0qQl1X0OrSWf6VNNS
            - img
          - button:
            - img
      - row "Spring's Emerald Embrace":
        - cell "Spring's Emerald Embrace"
        - cell:
          - link:
            - /url: /w/poem/aegwVWjad3v7RDZSSNDY
            - img
          - button:
            - img
      - row "New Poem Generator":
        ...
        - cell:
          - link:
            - /url: /w/poem/BSuJda4QkbaLnzijE8R7
            - img
          - button:
            - img
      - row "New Poem Generator":
