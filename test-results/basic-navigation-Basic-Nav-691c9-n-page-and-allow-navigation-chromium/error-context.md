...
- Name: Basic Navigation Tests (Chrome Only) >> should show login page and allow navigation
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/basic-navigation.spec.ts:24:7
...
Locator: locator('h2')
Expected string: "Sign in to your account"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('h2')

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/basic-navigation.spec.ts:30:38
```
