...
- banner:
  ...
  - navigation
- main:
  - heading "Golden Hour's Embrace" [level=1]
  - paragraph: "Workflow: Poem Generator"
  - text: Progress 3 / 7 Stages
  - progressbar
  - text: Last saved 7:44:56 PM
  - img
  ...
  - button "Edit":
    ...
    - text: Edit
  - img
  - text: Generate Poem & Title AI will generate a poem and title based on your topic. Poem Title Golden Hour's Embrace Poem Content The sun, a painter with a golden brush, Drenches the world in a vibrant hush. Emerald leaves, in a joyful dance, Catch the light in a sunlit trance. A gentle breeze, a whispered sigh, Carries the scent of earth and sky. Clouds drift lazily, white and serene, A peaceful vista, a tranquil scene. The honeybees hum a sweet refrain, As butterflies flutter across the plain. Warmth on the skin, a gentle caress, A perfect moment, nothing less. Worries fade in the sun's bright glow, Seeds of happiness begin to grow. A day to cherish, a memory bright, A golden hour bathed in light.
  - button:
    - img
