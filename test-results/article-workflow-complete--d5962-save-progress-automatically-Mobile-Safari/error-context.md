...
- Name: Complete Article Workflow >> should save progress automatically
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/article-workflow-complete.spec.ts:105:7
...
Call log:
  ...
  - waiting for locator('text=Saving').or(locator('text=Last saved'))

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/article-workflow-complete.spec.ts:119:83
```
...
- main:
  ...
  - textbox "Clearly state the main topic or keyword for your page.": Auto-save test topic
  - text: "Estimated Tokens: ~5"
  ...
  - img
  - text: "Waiting for: Define Your Topic Competitor Research (Optional) List a few competitor pages or URLs for analysis. You can use the Smart Dropzone to upload a text file with URLs, or paste them directly. Optional"
  - heading "Input:" [level=4]
