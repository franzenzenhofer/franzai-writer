...
- Name: Authentication >> should navigate to password reset page
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:45:7
...
Call log:
  - waiting for getByTestId('forgot-password-link')
    ...
    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:48:52
```
