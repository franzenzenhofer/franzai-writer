...
waiting for navigation to "**/wizard/**" until "load"
  ...
  navigated to "http://localhost:9002/w/article/rOCYegAOBEJG8RrKBrM7"
============================================================
    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/article-workflow-complete.spec.ts:15:16
```
...
- main:
  ...
  - progressbar
  - text: Last saved 9:33:28 PM Define Your Topic Clearly state the main topic or keyword for your page.
  - button:
    - img
  - textbox "Clearly state the main topic or keyword for your page."
  - button "Continue":
    - img
    - text: Continue
  - img
