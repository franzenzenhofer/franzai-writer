...
- Name: Authentication >> should validate password confirmation
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:66:7
...
Call log:
  - waiting for getByTestId('email-input')
    ...
    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:69:43
```
