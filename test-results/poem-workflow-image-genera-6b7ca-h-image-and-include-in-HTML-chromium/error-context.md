...
- main:
  ...
  - button "Edit":
    ...
    - text: Edit
  - img
  - text: Generate Poem & Title AI will generate a poem and title based on your topic. Poem Title Crimson Majesty Poem Content A titan sleeps, beneath a velvet shroud, While dawn's first breath, a promise whispered loud. A canvas dark, awaits the artist's hand, To paint the peak, with hues across the land. From indigo to violet, shadows flee, As golden light ascends triumphantly. The mountain wakes, a giant stretching slow, Reflecting fire, in rivers far below. Each jagged edge, a brushstroke sharp and bold, Revealing stories, centuries old. Of wind and ice, and patient, silent grace, A timeless wonder, in this sacred space. And as the sun, in fiery splendor bright, Crowns the high summit, bathed in golden light, A kingdom vast, unfolds before our eyes, A testament to beauty, 'neath the skies.
  - button:
    - img
