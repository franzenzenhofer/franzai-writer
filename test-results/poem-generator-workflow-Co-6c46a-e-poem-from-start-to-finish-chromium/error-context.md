...
- main:
  ...
  - button "Edit":
    ...
    - text: Edit
  - img
  - text: Generate Poem & Title AI will generate a poem and title based on your topic. Poem Title Gilded Hour Poem Content The sun, a painter with a golden brush, Across the canvas of the morning sky, Spreads hues of amber in a silent rush, As sleepy shadows bid a soft goodbye. Diamonds dance on dewdrops, newly born, A symphony of light upon the green, The air, a whisper, gently carried on, Of summer's promise, vibrant and serene. A gentle breeze, a playful, teasing hand, Rustles the leaves in melodies untold, Across the fields, a golden, shimmering strand, A story whispered, brave and bright and bold. Soak in this moment, let it fill your soul, This gilded hour, a treasure to embrace, Let worries fade, and make you whole, Lost in the beauty of this sunlit space.
  - button:
    - img
