...
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:54:7
...
Locator: getByTestId('signup-form-title')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('signup-form-title')

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:57:57
```
...
- banner:
  ...
  - navigation:
    - link "Login":
      - /url: /login
- main:
  - text: Create an account Enter your email and password to get started Email
  - textbox "Email"
  - text: Password
  - textbox "Password"
