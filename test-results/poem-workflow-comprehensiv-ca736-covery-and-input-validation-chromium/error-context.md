...
- Name: Poem Workflow - SUPER POWERFUL Comprehensive Tests >> Test error recovery and input validation
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/poem-workflow-comprehensive.spec.ts:303:7
...
Call log:
  - waiting for locator('#process-stage-poem-topic')

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/poem-workflow-comprehensive.spec.ts:323:16
```
...
- banner:
  ...
  - navigation:
    - link "Login":
      - /url: /login
- main:
  - heading "Twilight's Gentle Embrace" [level=1]
  ...
  - button:
    - img
  - text: Poem Title Twilight's Gentle Embrace Poem Content The sun descends, a final, fading gleam, And paints the canvas of the western sky. A hush descends, as if within a dream, Where day's loud echoes softly start to die. The hurried footsteps slow, then gently cease, The distant laughter fades into the air. A quiet settles, bringing sweet release, Dispelling every worry, every care. In this soft veil, where shadows start to creep, The weary spirit finds a deep repose. The world outside falls into slumber deep, As inner peace within the being grows. So let the twilight gather, calm and deep, And wrap the soul in its serene embrace. A silent promise that the moments keep, To find renewal in this tranquil space.
  - button:
    - img
  ...
  - textbox "Add any specific details you'd like in the image (e.g., 'warm colors', 'dramatic lighting', 'peaceful mood')": x
  - paragraph
  - text: Image Format
