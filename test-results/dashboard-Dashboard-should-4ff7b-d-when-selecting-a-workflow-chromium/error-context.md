...
- Name: Dashboard >> should navigate to wizard when selecting a workflow
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/dashboard.spec.ts:16:7
...
Locator: locator('[data-testid="workflow-card-recipe-seo-optimized"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('[data-testid="workflow-card-recipe-seo-optimized"]')

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/dashboard.spec.ts:20:30
```
