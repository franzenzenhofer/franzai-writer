...
- Name: Authentication >> should navigate to signup page
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:35:7
...
Call log:
  - waiting for getByTestId('signup-link')

    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/auth.spec.ts:38:43
```
