...
- Name: Basic Navigation Tests (Chrome Only) >> should navigate to workflow details page
- Location: /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/basic-navigation.spec.ts:65:7
...
Call log:
  ...
  - waiting for locator('h1')
    ...
    at /Users/franzenzenhofer/dev/franzai-writer/tests/e2e/basic-navigation.spec.ts:71:38
```
